...
สำหรับโรงเรียนที่ติดตั้งใหม่ แนะนำให้ใช้อีเมลจริงของโรงเรียนหรือ Gmail ของผู้ดูแล
เพื่อให้บัญชีมีความเป็นทางการและจำได้ง่าย
...
4. กรอกข้อมูล:
   - **Email**: อีเมลจริงของโรงเรียนหรือผู้ดูแล เช่น `schoolname@gmail.com`
...
> โรงเรียนที่ติดตั้งไว้ก่อนหน้านี้และใช้ `admin@admin.pp5.local` ยังเข้าสู่ระบบด้วย
> ชื่อผู้ใช้ `admin` ได้ตามเดิม ไม่ต้องแก้บัญชีหรือฐานข้อมูล
...
3. กรอก:
   - **อีเมล**: อีเมลจริงที่ใช้สร้างบัญชีในขั้นตอนที่ 3.1
